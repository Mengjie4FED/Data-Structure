...
{
    /* Your code goes here! */
    std::string word1U = word1;
    std::string word2U = word2;
    std::transform(word1.begin(), word1.end(), word1U.begin(), ::toupper);
    std::transform(word2.begin(), word2.end(), word2U.begin(), ::toupper);

    auto lookW1 = dict.find(word1U);
    if (lookW1 == dict.end()) {return false;}
    auto lookW2 = dict.find(word2U);
    if (lookW2 == dict.end()) {return false;}
    return (lookW1->second == lookW2->second);
}
